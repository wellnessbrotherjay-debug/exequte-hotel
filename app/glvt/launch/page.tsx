            ...
            <div className="relative z-10 h-screen flex flex-col justify-between py-6 px-6">
                ...
                <div className="pb-4">
                    ...
                    <div className="flex flex-col items-center gap-4 mt-6">
                        ...
                        <Link href="/glvt/login" className="text-[10px] uppercase tracking-widest text-[#C8A871] border-b border-[#C8A871]/30 pb-0.5 hover:text-white hover:border-white transition-colors">
                            Member Login
                        </Link>
                    </div>
                </div>
